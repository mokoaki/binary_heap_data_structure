...
RSpec.describe Heap do
  ...
  describe "empty pop" do
    ...
    it "empty pop(1)" do
      expect(heap.pop(1)).to match([])
    end

    it "empty pop(2)" do
      expect(heap.pop(2)).to match([])
    end
  end
  ...
  describe "push pop" do
    ...
    it "push(1) pop(2)" do
      heap.push(1)
      expect(heap.pop(2)).to match([1])
    end
  end

  describe "push push pop" do
    it "push(1) push(2) pop" do
      heap.push(1)
      heap.push(2)
      expect(heap.pop).to eq(1)
    end

    it "push(1) push(2) pop(0)" do
      heap.push(1)
      heap.push(2)
      expect(heap.pop(0)).to match([])
    end

    it "push(1) push(2) pop(1)" do
      heap.push(1)
      heap.push(2)
      expect(heap.pop(1)).to match([1])
    end

    it "push(1) push(2) pop(2)" do
      heap.push(1)
      heap.push(2)
      expect(heap.pop(2)).to match([1, 2])
    end

    it "push(2) push(1) pop(2)" do
      heap.push(2)
      heap.push(1)
      expect(heap.pop(2)).to match([1, 2])
    end
  ...
  describe "push pop_all" do
    it "push(1) push(2) push(3) pop_all" do
      heap.push(1)
      heap.push(2)
      heap.push(3)
    ...
    it "push(1) push(3) push(2) pop_all" do
      heap.push(1)
      heap.push(3)
      heap.push(2)
      expect(heap.pop_all).to match([1, 2, 3])
    ...
    it "push(2) push(1) push(3) pop_all" do
      heap.push(2)
      heap.push(1)
      heap.push(3)
      expect(heap.pop_all).to match([1, 2, 3])
    ...
    it "push(2) push(3) push(1) pop_all" do
      heap.push(2)
      heap.push(3)
      heap.push(1)
      expect(heap.pop_all).to match([1, 2, 3])
    ...
    it "push(3) push(1) push(2) pop_all" do
      heap.push(3)
      heap.push(1)
      heap.push(2)
      expect(heap.pop_all).to match([1, 2, 3])
    ...
    it "push(3) push(2) push(1) pop_all" do
      heap.push(3)
      heap.push(2)
      heap.push(1)
      expect(heap.pop_all).to match([1, 2, 3])
  ...
  describe "push.push.push pop_all" do
    it "push(1).push(2).push(3) pop_all" do
  ...
  describe "push() pop_all" do
    it "push(1, 2, 3) pop_all" do
      heap.push(1, 2, 3)
      expect(heap.pop_all).to match([1, 2, 3])
    end

    it "push(1, 3, 2) pop_all" do
      heap.push(1, 3, 2)
      expect(heap.pop_all).to match([1, 2, 3])
    end

    it "push(2, 1, 3) pop_all" do
      heap.push(2, 1, 3)
      expect(heap.pop_all).to match([1, 2, 3])
    end
    ...
    it "push(3, 1, 2) pop_all" do
      heap.push(3, 1, 2)
      expect(heap.pop_all).to match([1, 2, 3])
    end

    it "push(3, 2, 1) pop_all" do
      heap.push(3, 2, 1)
      expect(heap.pop_all).to match([1, 2, 3])
    end
  end
